...
import (
	...
	"nowim.message/internal/channel"
...
func NewMessageServer() message.MessageServer {
	return messageServerImpl{repo: domain.NewMemMessageRepo()}
}
